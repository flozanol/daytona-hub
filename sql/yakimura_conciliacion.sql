-- Yakimura: Conciliacion Inventario vs Historico
-- Devuelve 3 conjuntos:
-- 1) ventasConInventario: variantes con match valido
-- 2) inventarioSinHistorico: unidades sin historico compatible
-- 3) resumen: conteos para validar
